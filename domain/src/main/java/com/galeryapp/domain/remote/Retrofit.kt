package com.galeryapp.domain.remote

import com.galeryapp.domain.BuildConfig
import com.galeryapp.domain.datasource.FlickerDatasource
...
val flickrRetrofit by lazy { instantiate<FlickerDatasource>(BuildConfig.API_URL) }
